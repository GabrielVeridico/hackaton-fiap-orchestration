...
| `cs-prometheus` / `cs-grafana` *(profile `observability`)* | prom/prometheus, grafana | `9090` / `3000` | métricas locais |
...
- Grafana: `http://localhost:3000` (anônimo habilitado; admin/`admin`), datasource Prometheus provisionado.
